...
function displayResult(item, fields, url) {
  ...
  return `<div class="result"><a href="${url}${link}">${thumb}<p><span class="title">${item.entry}</span><br><span class="meta">${meta.join(' | ')}</span></p></a></div>`;
}
