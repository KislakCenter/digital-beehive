...
issue: The point of reference for "Clemency" is not entirely clear. We linked to 1120
  [Clemency], which is the first relevant entry in the numerical section of the Alvearium.
also_in_entry:
order: '020'
layout: alpha_item
collection: num1
