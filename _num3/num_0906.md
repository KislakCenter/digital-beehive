...
issue: The points of reference for "Displeasure" and "Lothing" are not entirely clear.
  The Octavo index indicates that 615 [Well done] and 779 [Loathing] might be the
  earliest occuring relevant entries, but 779 [Loathing] is on a missing page.
also_in_entry:
order: '275'
layout: alpha_item
collection: num3
