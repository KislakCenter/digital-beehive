...
issue: The point of reference for "Verbatim" is not entirely clear. We linked to 536
  [Verbatim], which is the first relevant entry in the numerical section of the Alvearium.
also_in_entry:
order: '274'
layout: alpha_item
collection: num2
