...
issue: The point of reference for "Torturing" is not entirely clear. We linked to
  419 [Torturing], which is the first relevant entry in the numerical section of the
  Alvearium.
also_in_entry:
order: '270'
layout: alpha_item
